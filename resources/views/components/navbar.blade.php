<nav class="navbar navbar-expand-lg bg-body-tertiary">
    <div class="container-fluid">
      <a class="navbar-brand" href="{{route("welcome")}}">Birre125</a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link" href="">Catalogo Birre</a>
          </li>         
          @guest
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              ...
              <li><a class="dropdown-item" href="{{route("brewery.create")}}">Inserisci il tuo Pub</a></li>
              <li><a class="dropdown-item" href="{{route("brewery.index")}}">I tuoi Prodotti</a></li>
